...
| `format`          |[ChartFormat](chartrangeformat.md) Object | Represents the format of a chart object, which includes fill(interior/background), line/border and font formatting.
